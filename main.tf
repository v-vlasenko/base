...
variable "null_hcl_var" {
  description = "Test: null/empty value with hcl=true (item 16)"
  default     = "not_set"
}
...
variable "shared_key" {
  description = "Test: shared key across 20 sets - alphabetical winner"
  default     = "not_set"
}
...
output "null_hcl_var_value" { value = var.null_hcl_var }
